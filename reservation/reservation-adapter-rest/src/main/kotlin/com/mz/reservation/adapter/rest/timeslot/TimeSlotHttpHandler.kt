package com.mz.reservation.adapter.rest.timeslot

import com.mz.common.components.adapter.http.HttpHandler
import com.mz.ddd.common.api.domain.Id
import com.mz.reservation.adapter.rest.timeslot.model.TimeSlotCommandRequest
...
class TimeSlotHttpHandler(private val timeSlotApi: TimeSlotApi) : HttpHandler {
    override fun route(): RouterFunction<ServerResponse> {
        ...
        return RouterFunctions.route()
            .nest(RequestPredicates.path("/reservation-system/time-slot"), Supplier { route })
            .build()
    }
